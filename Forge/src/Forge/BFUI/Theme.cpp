...
void Theme::SetDarkTheme()
{
    ...
    // Button Colors
    SetColor(WidgetType::Button, WidgetState::Default, glm::vec4(0.260f, 0.590f, 0.980f, 1.000f));
    SetColor(WidgetType::Button, WidgetState::Hover, glm::vec4(0.400f, 0.670f, 1.000f, 1.000f));
    SetColor(WidgetType::Button, WidgetState::Pressed, glm::vec4(0.200f, 0.500f, 0.880f, 1.000f));
    SetColor(WidgetType::Button, WidgetState::Disabled, glm::vec4(0.260f, 0.590f, 0.980f, 0.500f));
