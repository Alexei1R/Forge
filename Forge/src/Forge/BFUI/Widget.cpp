...
Widget::Widget() : m_Padding(vec4i(8))
{
    ...
    Handle shaderHandle = shaderManager.LoadShader(Forge::ShaderLayout {
        {Forge::ShaderType::VERTEX, "Assets/Shaders/UI/Default.vert"},
    ...
    m_DefaultMaterial->SetParameter("BorderColor",
                                    Theme::GetColor(WidgetType::Border, WidgetState::Default));
    ...
    m_WidgetBufferLayout = {
        {Forge::BufferDataType::Float2, "a_Position"},
        {Forge::BufferDataType::Float4, "a_Color"},
