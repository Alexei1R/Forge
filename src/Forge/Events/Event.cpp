...
std::vector<bool> Keyboard::m_Keys(256, false);  // Assuming 256 possible keys for simplicity
...
std::pair<double, double> const Mouse::GetMousePosition() { return {x, y}; }
...
std::pair<double, double> const Mouse::GetMouseDeltaScroll() { return {scrollDx, scrollDy}; }
...
std::pair<double, double> const ApplicationStats::GetApplicationPosition() { return {appPosX, appPosY}; }

std::pair<double, double> const ApplicationStats::GetApplicationSize() { return {appWidth, appHeight}; }

bool ApplicationStats::IsFullscreen() { return fullscreen; }

bool ApplicationStats::IsFloating() { return floating; }

bool ApplicationStats::IsFocused() { return focused; }
...
void ApplicationStats::SetFullscreen(bool isFullscreen) { fullscreen = isFullscreen; }

void ApplicationStats::SetFloating(bool isFloating) { floating = isFloating; }

void ApplicationStats::SetFocused(bool isFocused) { focused = isFocused; }
}  // namespace Forge
